...
const JumboContentLayout = ({
  ...
  React.useEffect(() => {
    if (layoutOptions) contentLayout.setContentLayout(layoutOptions);
  }, [layoutOptions]);
  ...
  return (
    ...
    >
      {header && contentLayout.header.spreadOut && (
        <JumboContentLayoutHeader>{header}</JumboContentLayoutHeader>
      )}
      <Box
      ...
      >
        {sidebar && (
          <JumboContentLayoutSidebar>{sidebar}</JumboContentLayoutSidebar>
        )}
        {
          <JumboContentLayoutMain>
            ...
            {footer && !contentLayout.footer.spreadOut && (
              <JumboContentLayoutFooter>{footer}</JumboContentLayoutFooter>
            )}
          </JumboContentLayoutMain>
        }
      </Box>
